...
import { Button } from '../ui/Button'; // Assuming Button component exists here or adjust path
...
const AppHeader: React.FC<AppHeaderProps> = ({ user }) => {
    ...
    return (
        <header className="sticky top-0 z-30 bg-white/80 backdrop-blur-md border-b border-gray-100">
            {/* Top Loading Bar (Optional Placeholder) */}
            {/* <div className="h-[2px] w-full bg-blue-600 fixed top-0 left-0 z-50"></div> */}
